...
RUN apk add --no-cache ca-certificates wget \
    ...
    && python3 -m pip install install https://github.com/dlenski/vpn-slice/archive/master.zip


# always add the docker DNS server, TODO run the command when start container
